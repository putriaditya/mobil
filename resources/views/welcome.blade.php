    ...
    <div class="container">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="/logoutaksi"><i class="fa fa-power-off"></i> Log Out</a></li>
                  </ul>
                </li>
              </ul>
            </div><!-- /.navbar-collapse -->
		...
		<tr>
            ...
            @if ($m->status == 1)
                        ...
                        @else
                        <td> <span class="badge bg-danger">Tersedia</span> </td>
                        @endif
			<td>
				<a href="">Edit</a>
				|
				<a href="{{ route('mobil.destroy', $m->id) }}">Hapus</a>
			</td>
		</tr>
		@endforeach
	</table>
